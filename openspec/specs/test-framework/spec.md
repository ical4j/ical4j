...
Defines the requirements for the project's Java test framework — what engine tests use, what styles are permitted, and how parameterised tests are expressed.
